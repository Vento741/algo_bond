...
export function TgPnlWidget({ totalPnl, winRate, totalTrades }: TgPnlWidgetProps) {
    ...
    <div className="rounded-xl border border-white/[0.08] bg-gradient-to-br from-[#1a1a2e] to-[#0d0d1a] p-4">
      ...
      <div className="mt-3 flex gap-4">
        ...
        <div>
          ...
          <p className="font-['JetBrains_Mono'] text-sm font-semibold text-white">{totalTrades}</p>
        </div>
      </div>
    </div>
  );
