...
- [x] **Step 1: Создать директорию проекта и инициализировать git**
...
- [x] **Step 1: Создать orchestrator.md**
...
- [x] **Step 2: Создать backend-dev.md**
...
- [x] **Step 3: Создать frontend-dev.md**
...
- [x] **Step 4: Создать researcher.md**
...
- [x] **Step 6: Создать algorithm-engineer.md**
...
- [x] **Step 8: Создать code-reviewer.md**
...
- [x] Файлы < 300 строк (если больше — повод для декомпозиции)

### Безопасность
- [x] Нет хардкоженных секретов (API ключи, пароли)
- [x] SQL-запросы через ORM или параметризованные
- [x] Нет XSS в React (dangerouslySetInnerHTML)
- [x] CORS настроен правильно (не *)
- [x] JWT токены валидируются
- [x] API ключи пользователей зашифрованы (AES-256)
- [x] Rate limiting на критичных endpoints

### Производительность
- [x] Нет N+1 запросов (используй joinedload/selectinload)
- [x] Индексы на часто запрашиваемых полях
- [x] Кэширование в Redis где уместно
- [x] Async операции где возможно

### Архитектура
- [x] Модули не нарушают границы друг друга
- [x] Service layer между router и models
- [x] Pydantic schemas для входа/выхода API
...
- [x] **Step 9: Создать consultant.md**
...
- [x] **Step 10: Создать market-analyst.md**
...
- [x] **Step 3: Создать strategy-test.md**
...
- [x] **Step 4: Создать db-migrate.md**
...
- [x] **Step 5: Создать market-check.md**
...
- [x] **Step 6: Создать bot-control.md**
...
- [x] **Step 7: Создать pine-convert.md**
...
- [x] **Step 1: Создать settings.json**
...
- [x] **Step 2: Создать pre-commit.sh**
...
- [x] **Step 3: Создать commands/status.md**
...
- [x] **Step 4: Создать commands/logs.md**
...
- [x] **Step 5: Создать commands/health.md**
...
- [x] **Step 6: Коммит хуков и команд**
...
- [x] **Step 3: Создать app/__init__.py**

```python
"""AlgoBond — платформа алгоритмической торговли."""
```

- [x] **Step 4: Создать main.py**
...
- [x] **Step 5: Написать тест для health endpoint**
...
- [x] **Step 7: Запустить тест локально (проверка)**
...
- [x] **Step 3: Создать vite.config.ts**
...
- [x] **Step 4: Создать tsconfig.json**
...
- [x] **Step 5: Создать tailwind.config.js**
...
- [x] **Step 6: Создать postcss.config.js**
...
- [x] **Step 7: Создать src/index.css**
...
- [x] **Step 1: Создать docker-compose.yml (development)**
...
- [x] **Step 2: Создать docker-compose.prod.yml**
...
- [x] **Step 3: Создать nginx/nginx.conf (development)**
...
- [x] **Step 4: Создать nginx/nginx.prod.conf**
...
- [x] **Step 2: Сделать скрипт исполняемым**

```bash
chmod +x scripts/deploy.sh
```

- [x] **Step 3: Подключить remote репозиторий**

```bash
git remote add origin git@github.com:Vento741/algo_bond.git
```

- [x] **Step 4: Перенести документацию из ASO_tw**
...
- [x] **Step 1: Клонировать репозиторий на VPS**
...
- [x] **Step 3: Запустить Docker Compose**
...
- [x] **Step 4: Проверить healthcheck**
...
- [x] **Step 5: Проверить доступность по домену**
...
- [x] **Step 6: Коммит подтверждения деплоя в CHANGELOG**
